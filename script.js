const CHARLOS_COMMANDS = [
  {
    ...
    commands: [
      ...
      { name: 'createchannel', desc: 'Creates a new text or voice channel', usage: '<#channel> <text/voice>' },
      ...
      { name: 'unban', desc: 'Lifts a ban on a user', usage: '<user id>' },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'bomb', desc: 'Risks cash on a bomb minigame', usage: null },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'channelinfo', desc: 'Shows info about a channel', usage: '<#channel>' },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'compliment', desc: 'Sends a random compliment', usage: '<mention>' },
      ...
      { name: 'roast', desc: 'Sends a random roast', usage: '<mention>' },
      ...
      { name: 'spouse', desc: 'Shows your current marriage partner', usage: null },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'base64', desc: 'Encodes or decodes base64 text', usage: '<text>' },
      ...
      { name: 'currency', desc: 'Converts between currencies', usage: '<amount> <from> <to>' },
      ...
      { name: 'qr', desc: 'Generates a QR code', usage: '<text>' },
      { name: 'say', desc: 'Makes the bot say a message', usage: '<message>' },
      ...
      { name: 'sudo', desc: 'Sends a message as another user (staff)', usage: '<mention> <message>' },
      ...
      { name: 'translate', desc: 'Translates text between languages', usage: '<text>' },
      ...
      { name: 'weather', desc: 'Checks the weather for a location', usage: '<location>' },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'tableflip', desc: 'Sends a table-flip roleplay gif', usage: null },
