const CHARLOS_COMMANDS = [
  ...
  },
  {
    ...
    commands: [
      { name: 'adventure', desc: 'Goes on a random cash-earning and items adventure', usage: null },
      ...
      { name: 'chop', desc: 'Chops log you can sell for cash', usage: null },
      ...
      { name: 'explore', desc: 'Explores random location for cash', usage: null },
      ...
      { name: 'roulette', desc: 'Bets cash on russian roulette', usage: '<amount>' },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'element', desc: 'Looks up a periodic table element', usage: '<number/symbol/name>' },
      { name: 'embed', desc: 'Builds a custom embed message', usage: '<title> | <description> | <footer> | <hex>' },
      { name: 'enlarge', desc: 'Enlarges a custom emoji or a unicode emoji', usage: '<emoji>' },
      { name: 'github', desc: 'Searches GitHub for a user information', usage: '<username>' },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'gun', desc: 'Puts a gun meme filter on an avatar with text', usage: '<mention> <text>' },
      ...
      { name: 'pooh', desc: 'Generates a regular/fancy Pooh meme', usage: '<text> / <text>' },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'food', desc: 'Sends a random food recipe', usage: null },
      { name: 'history', desc: 'Sends a historical event of today', usage: null },
      { name: 'inspire', desc: 'Sends an inspirational quote', usage: null },
      { name: 'iss', desc: 'Shows the ISS\'s current location', usage: null },
      { name: 'nasa', desc: 'Sends NASA\'s astronomy picture of today', usage: null },
